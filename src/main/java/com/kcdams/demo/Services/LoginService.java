...
import com.kcdams.demo.Repository.LoginRepository;
...
public class LoginService {
    ...
    public Users saveUsers(loginDTO lgn) {
        final String secretKey = "halima123456789@gmail.com";
        Users l = new Users();
        l.setPassword(encrypt(lgn.getPassword(), secretKey));
        l.setUsername(lgn.getUsername());
        l.setUserStatus("1");
        l.setRoleId(lgn.getRoleId());
