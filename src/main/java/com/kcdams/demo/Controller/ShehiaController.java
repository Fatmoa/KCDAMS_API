...
public class ShehiaController {
    ...
    public List<Shehia> allShehiaByDistrictCodeStatusOne(@PathVariable int district_code) {
        return shehiaService.allShehiaByDistrictCodeStatusOne(district_code);
    }
    ...
    @GetMapping("/byDistrictCode/{districtCode}")
    public List<Shehia> allShehiaByDistrictCode(@PathVariable int districtCode) {
        return shehiaService.allShehiaByDistrictCode(districtCode);
    }
}